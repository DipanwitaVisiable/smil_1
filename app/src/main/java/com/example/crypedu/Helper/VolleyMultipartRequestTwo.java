...
public class VolleyMultipartRequestTwo extends Request<JSONObject> {
  ...
  public VolleyMultipartRequestTwo(String url, Map<String, String> headers,
  ...
  public VolleyMultipartRequestTwo(int method, String url,
                                   Response.Listener<JSONObject> listener,
                                   Response.ErrorListener errorListener) {
