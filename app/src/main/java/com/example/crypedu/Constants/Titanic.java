...
/**
 * Created by Chandan on 19-01-2018.
 */
    ...
    public void start(final TitanicTextView textView) {
        ...
        final Runnable animate = new Runnable() {
            ...
            public void run() {
                ...
                @SuppressLint("AnimatorKeep") ObjectAnimator maskXAnimator = ObjectAnimator.ofFloat(textView, "maskX", 0, 200);
                ...
                @SuppressLint("AnimatorKeep") ObjectAnimator maskYAnimator = ObjectAnimator.ofFloat(textView, "maskY", h / 2, -h / 2);
