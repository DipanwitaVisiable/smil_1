...
public class ClassWorkAdapter extends BaseAdapter {
    ...
    public ClassWorkAdapter(Context context, List<ClassWorkInfo> classWorkInfoList, LayoutInflater inflater) {
        mInflater = inflater;
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        itemView = inflater.inflate(R.layout.class_work_adapter, parent, false);
